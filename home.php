...
$result1 = mysqli_query($con, "select * from posts  order by posts_id DESC");
...
<body>
  <header>
    <div class="display">
      <img class="logo" src="brandnewlogo.png" alt="logo" height="60px" width="60px" />
    </div>
    <div class="Searchbar">
  ...
  <div class="post">
    <form method="POST" action="posting.php" enctype="multipart/form-data">
      <div class="pimg">
        ...
        <input type="text"  name="posttext" placeholder="Write a post" id="button-post" />
      </div>

      <div class="fileinput" >
        <input type="file" id="upload" name="image" hidden/>
        <label for="upload">Upload</label>
        <!-- <button class="post-butt">POST</button> -->
      </div>
      </div>
      <button class="post-butt" name="upload" action="posting.php">POST</button>
      </div>
